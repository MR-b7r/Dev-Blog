    ...
    <nav className="bg-primary-50 border-gray-200 dark:bg-gray-800 w-full">
      <div className="max-w-screen-xl flex items-center justify-between flex-wrap mx-auto p-4">
        ...
        <div className="flex gap-2 ">
          <div className="p-2 border border-gray-300 rounded-full bg-gray-50 dark:bg-gray-700 dark:border-gray-600  dark:text-white flex-center cursor-pointer">
        ...
        {/* <div className="w-full md:block md:w-auto">
          <ul className="mt-4 flex flex-col md:mt-0 md:flex-row md:space-x-8 md:text-sm md:font-medium"></ul>
        </div> */}
      </div>
    </nav>
  );
